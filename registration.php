		  ...
		  {			  
             ...
             $res_e = mysqli_query($conn, $sql_e);
               if(mysqli_num_rows($res_e) > 0 ){
           	  echo"<script>alert('Useremail is already taken')</script>";
               }else{
              // check e-mail address ends here
			  $qry="INSERT INTO `user`(`user_id`, `full_name`, `useremail`, `username`, `password`) VALUES ('','$fname','$email','$uname','$hashed_password')";			  			  
          ...
          <div>
            <h2>Registration</h2>
              ...
              <div>
                ...
                <div>
                <h3><b>Username</b></h3>
                <input name='uname' value='' placeholder='Enter Full Name' required ></input>              
              </div>
              <div>
                <h3>Password</h3>
                <input name='pword' value='' type='password'  placeholder='Enter Password' ></input>
                
              </div>
              <div>
                <h3>Re-type Password</h3>
                <input name='vpword'  value='' type='password'  placeholder='Re-type Password'  ></input>
