    ...
    <section className="form-container">
          <div>
            <h2>Registration</h2>
              ...
              <div>
                <h3>Email</h3>
                <input name='email' id='email' value='' type='email'  placeholder='Enter Email Address' required></input>
  	...
  	<?php
		  ...
		  {			  
              ...
              $sql_e = "SELECT * FROM `user` WHERE full_name='$fname'";
              $res_e = mysqli_query($conn, $sql_e);
              if(mysqli_num_rows($res_e) > 0){
           	  echo"<script>alert('Email is already taken')</script>";
               }else{
              // check e-mail address ends here
			  $qry="INSERT INTO `user`(`user_id`, `full_name`, `email`, `password`) VALUES ('','$fname','$email','$hashed_password')";			  			  
