...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 11, 2020 at 03:44 PM
...
--
-- Table structure for table `bindingwire`
--

CREATE TABLE `bindingwire` (
  `binding_id` int(11) NOT NULL,
  `selected_size` varchar(60) NOT NULL,
  `price` varchar(60) NOT NULL,
  `kg` varchar(60) NOT NULL,
  `price2` varchar(60) NOT NULL,
  `selected_length` varchar(60) NOT NULL,
  `a_cut_of_binding_wire` varchar(60) NOT NULL,
  `diameters` varchar(60) NOT NULL,
  `length_per_kg` varchar(60) NOT NULL,
  `selected_size2` varchar(60) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `bindingwire`
--

INSERT INTO `bindingwire` (`binding_id`, `selected_size`, `price`, `kg`, `price2`, `selected_length`, `a_cut_of_binding_wire`, `diameters`, `length_per_kg`, `selected_size2`) VALUES
(4, 'Kg of Binding Wire', '12000', '25', '480', '61.353', '0.2', '2.64', '61353', '2.64'),
(5, '', '', '', '', '', '', '3.15', '51439', ''),
(6, '', '', '', '', '', '', '3.8', '42636', '');
...
--
-- Table structure for table `bindingwirerst`
--

CREATE TABLE `bindingwirerst` (
  `id` int(11) NOT NULL,
  `project_id` int(40) NOT NULL,
  `name1` varchar(40) NOT NULL,
  `price1` varchar(40) NOT NULL,
  `name2` varchar(40) NOT NULL,
  `price2` varchar(40) NOT NULL,
  `name3` varchar(40) NOT NULL,
  `price3` varchar(40) NOT NULL,
  `name4` varchar(40) NOT NULL,
  `price4` varchar(40) NOT NULL,
  `name5` varchar(40) NOT NULL,
  `price5` varchar(40) NOT NULL,
  `name6` varchar(40) NOT NULL,
  `price6` varchar(40) NOT NULL,
  `name7` varchar(40) NOT NULL,
  `price7` varchar(40) NOT NULL,
  `name8` varchar(40) NOT NULL,
  `price8` varchar(40) NOT NULL,
  `name9` varchar(40) NOT NULL,
  `price9` varchar(40) NOT NULL,
  `name10` varchar(40) NOT NULL,
  `price10` varchar(40) NOT NULL,
  `name11` varchar(40) NOT NULL,
  `price11` varchar(40) NOT NULL,
  `a_roll_by_kg` varchar(40) NOT NULL,
  `price_kg` varchar(40) NOT NULL,
  `diameter` varchar(40) NOT NULL,
  `price_per_kg` varchar(40) NOT NULL,
  `binding_wire_length` varchar(40) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(3, 5, 'Gerard Roofing', '2\" x 6\" x 12', '4\" x 4\" x 12', '2\" x 6\" x 12', '3\" x 4\" x12', '3\" x 4\" x12', '2\" x 6\" x 12', '2\" x 2\" x 12', '2\" x 4\" x 12', '5', '2\" x 6\" x 12', 1, 1, 1, 1, 0, 1, 1, 2, 2, 2600, 3100, 3100, 3100, 3100, 2000, 2000, 0, 17, 2000, 3900, 11, 2, 2, 4, 4, 2, 4, 4);
...
--
-- Indexes for table `bindingwire`
--
ALTER TABLE `bindingwire`
  ADD PRIMARY KEY (`binding_id`);

--
-- Indexes for table `bindingwirerst`
--
ALTER TABLE `bindingwirerst`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `bindingwire`
--
ALTER TABLE `bindingwire`
  MODIFY `binding_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `bindingwirerst`
--
ALTER TABLE `bindingwirerst`
