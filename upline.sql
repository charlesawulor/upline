...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 30, 2020 at 04:04 PM
...
INSERT INTO `gravel` (`id`, `name`, `price`, `ton`, `size_of_excavator`, `number_of_excavator`, `price_ton`, `price_truck`) VALUES
(1, 'gravel', '245000', '30', '0.700', '21', '8166.67', '245000');
...
INSERT INTO `user` (`user_id`, `full_name`, `us_email`, `username`, `password`) VALUES
(40, 'Charles Awu', 'c.awulor@ya', 'cawulor', '$2y$10$7Lw4'),
(41, 'Oge Awulor', 'o@yahoo.com', 'cawulor1', 'awulor'),
(42, 'Charles', 'c.awulor@ya', 'oge', '$2y$10$P1pV');
...
--
ALTER TABLE `blocks_result`
  MODIFY `block_rslt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
