            ...
            <h2>Roof settings</h2>
				...
				<?php
							...
							while($row = mysqli_fetch_array($run)){
								$rid = $row['roofid'];
								$rty = $row['type'];
								echo "<li><a href='roofing.php?id=$rid'>$rty</a></li>";
							}
							?>	 
...
?>
              ...
              <div>
                ...
                <input name='widt' id='wid'  onKeyup='calculate()' placeholder='Enter Block Width'></input>
            
              </div>
              <div>
                <h3>Tie beam<br> (width)</h3>
                <input name='lent' id='len'  onKeyup='calculate()' placeholder='Enter Block Length'  onkeyup='calculate()'></input>
              ...
              <div>
                ...
                <input name='mort' id='mor'  onKeyup='calculate()' placeholder='Enter Mortar Size'  onkeyup='calculate()'></input>
                
              </div>
              <div>
                <h3>Trusses<br>(width)</h3>
                <input name='pric' id='pri'  placeholder='Enter Price' ></input>
                
              </div>
              <div>
                <h3>Purlins<br>(width)</h3>
                <input name='dlab' id='dla'  placeholder='Down Labour' ></input>
                
              </div>
              <div>
                <h3>Inside noggins<br>(width)</h3>
                <input name='ulab' id='ula'   placeholder='Up Labour' ></input>
                
              </div>
              <div>
                <h3>Outside noggins<br>(width)</h3>
                <input name='cheit' id='acb'  placeholder='Course Height'></input>
